...
try:
    ...
    print(f"❌ Error: Google Generative AI package not found! {e}")
...
try:
    ...
    print(f"❌ Error: LangGraph packages not found! {e}")
...
class HTMLAgent(GeminiAgent):
    ...
    def _generate_inline_html(self, business_info: BusinessInfo, design: Dict, content: Dict, images: Dict) -> str:
